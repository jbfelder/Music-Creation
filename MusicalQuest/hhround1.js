...
function newRound(){
  ...
  if(round1==6){
    ...
    document.location.href = "http://www.cs.unc.edu/Courses/comp580-s17/users/MusicalQuest/hiphopround2.html";
    return;
  }
...
$(document).ready(function(){
  ...
  responsiveVoice.speak("Welcome to round 1 of Hip Hop Simon Says. Your goal is to hit the same keys spoken to you. When you are ready, press start to begin the game");
